...
{    
     ...
     * @return void
     * 
     * Displays all the quotes to search in a ddatatable
     */
    public function read_object() 
    {
        ...
        foreach ($result as $print) {
            ...
            // $predefined_tasks = explode(' ,', $predefined_tasks_json);
...
$search_quotes = new Search_Quotes();

$button_id      = "create_quote_on_search_quote";
$action_page    = "admin.php?page=sm-quote-creation-1a";
