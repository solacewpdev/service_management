...
{    
    ...
    use Trait_View_Predefined_Global_Tasks; 
    ...
    {
        if ( isset( $_POST['submit_to_create_quote_screen4'] ) )
        {
            if ( isset( $_POST['local_predefined_tasks'] ) )
            {
                $local_predefined_tasks_transient = $_POST['local_predefined_tasks'];
                set_transient('local_predefined_tasks_transient', $local_predefined_tasks_transient, 2592000);
            } else {
                $local_predefined_tasks_transient = array('LocalTasks' => '0');
                set_transient('local_predefined_tasks_transient', $local_predefined_tasks_transient, 2592000);
            }
...
$quote_creation_step4 = new Create_Quote_Screen4();
