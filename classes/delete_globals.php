...
class Delete_Global_Task
{
    ...
    public function delete_global_predefined_task()
    {
        if ( isset( $_POST['delete_predefined_tasks'] ) ) 
        {

            $task_to_delete_id = $_POST['delete_predefined_task_id'];
            ...
            foreach ($result as $print) 
            {
                ...
                $delete_task_form = <<<HTML
                    ...
                    <form method="POST" enctype="multipart/form-data" id="create-tasks" action="admin.php?page=sm-globals">
            ...
            <script>
                window.location.href = "admin.php?page=sm-globals";
            </script>
...
$delete_predefined_task = new Delete_Global_Task();
$delete_predefined_task->delete_global_predefined_task();