...
{    
    ...
    { 
        ...
        $update_task_form = <<<HTML
            ...
            <h5 class="card-title">Update Global Predefined Task:</h5>
            ...
            <form method="POST" enctype="multipart/form-data" id="create-tasks" action="admin.php?page=sm-create-quote-screen4">
            ...
            if (!isset($_POST['quotes_update_task_page'])) { ?>
                <script>
                    print('<script>window.location.href="admin.php?page=sm-create-quote-screen4"</script>');
                </script>
            <?php
